...
test("paid root resolves to the paid room entry page", () => {
    assert.equal(
        ...
        "https://www.falafel.com.br/evanopolis-v1/room-entry.html?chain_id=421614",
    );
});
...
test("free path resolves to the free room entry page", () => {
    assert.equal(
        ...
        "https://www.falafel.com.br/evanopolis-v1/free-entry.html?player_count=2",
    );
});
...
test("asset and client paths remain unchanged below the upstream base path", () => {
    assert.equal(
        ...
        "https://www.falafel.com.br/evanopolis-v1/free-client.js?v=123",
    );
});
